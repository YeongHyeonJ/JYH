...
<form class="body container" method="post" action="<%=request.getContextPath()%>/mypage">
	<h1 class="title text-center">회원 정보 수정</h1>
		<div class="form-group">
			<input type="text" class="form-control" value="${user.me_id}" readonly name="me_id">
		</div>
		<div class="form-group">
		...
		<button class="btn btn-outline-success btn-mod col-12" id="btn-modify">회원 정보 수정</button>
</form>
<script>
...
$('form').submit(function(){
	...
	if(me_pw == '' || me_address == ' '){
		return confirm('비밀번호와 주소가 입력되지 않아 이전 정보로 저장됩니다.')
	}
});
